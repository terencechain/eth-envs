...
SCRIPTDIR=/Users/t/eth-envs/epbs # TODO: change this to your eth-ens dir

DATADIR=/Users/t/epbs/${GENESIS} # TODO: change this to your tmp dir for logging and data
mkdir -p $DATADIR
...
$CTL_CMD testnet generate-genesis \
	--num-validators=1024 --output-ssz=$DATADIR/genesis.ssz \
